...
// Inisialisasi dropdown bahasa menggunakan Bootstrap
$(document).ready(function() {
    $('.lang-dropdown-toggle').dropdown();
});


// JavaScript untuk dark mode/light mode
function darkLight() {
    const body = document.body;
    const darkElements = document.querySelectorAll('.dark-n');
    const lightElements = document.querySelectorAll('.light-n');

    body.classList.toggle('dark-mode'); // Toggling dark mode pada body

    // Mengubah warna latar belakang dan teks elemen-elemen yang memiliki class dark-n atau light-n
    darkElements.forEach(function(element) {
        element.style.display = (body.classList.contains('dark-mode')) ? 'inline' : 'none';
    });

    lightElements.forEach(function(element) {
        element.style.display = (body.classList.contains('dark-mode')) ? 'none' : 'inline';
    });
}